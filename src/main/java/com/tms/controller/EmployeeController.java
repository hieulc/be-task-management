...
public class EmployeeController {
	...
	@GetMapping
	public EmployeePagedList getEmployees(			
	...
	public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
			try {
				...
				AuthenticationResponse authenResponse = 
						new AuthenticationResponse(username, accessToken, refresh_token, authorities);
...
//	}
	...
	private List<String> getAuthorities(Employee tokenSubject) {
		return tokenSubject.getEmpRoles()
				.stream()
